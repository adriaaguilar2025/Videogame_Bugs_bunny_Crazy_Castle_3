...
void Perro::init(const glm::vec2& tileMapPos, ShaderProgram& shaderProgram, TileMap* tileMap)
{
	movingRight = true;
	speed = 0.5f;
	map = tileMap;
	...
	sprite->addKeyframe(MOVE_LEFT, glm::vec2(frameWidth * 9.0f, frameHeight * 2.0f));
	sprite->addKeyframe(MOVE_LEFT, glm::vec2(frameWidth * 10.0f, frameHeight * 2.0f));
	sprite->addKeyframe(MOVE_LEFT, glm::vec2(frameWidth * 11.0f, frameHeight * 2.0f));
	sprite->addKeyframe(MOVE_LEFT, glm::vec2(frameWidth * 10.0f, frameHeight * 2.0f));

	sprite->setAnimationSpeed(MOVE_RIGHT, 8);
	sprite->addKeyframe(MOVE_RIGHT, glm::vec2(frameWidth * 6.0f, frameHeight * 2.0f));
	sprite->addKeyframe(MOVE_RIGHT, glm::vec2(frameWidth * 7.0f, frameHeight * 2.0f));
	sprite->addKeyframe(MOVE_RIGHT, glm::vec2(frameWidth * 8.0f, frameHeight * 2.0f));
	sprite->addKeyframe(MOVE_RIGHT, glm::vec2(frameWidth * 7.0f, frameHeight * 2.0f));
...
int Perro::update(int deltaTime, Player* player, float teleportCooldown, const std::vector<Entity*>& entities)
{
